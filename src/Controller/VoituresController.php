...
class VoituresController extends AbstractController
{
    ...
    /**
     * @Route("/{idvoit}", name="app_voitures_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idvoit}/edit", name="app_voitures_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{idvoit}", name="app_voitures_delete", methods={"POST"})
     */

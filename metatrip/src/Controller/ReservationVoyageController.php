...
class ReservationVoyageController extends AbstractController
{
     ...
     */
    public function indexImrpimer(\Swift_Mailer $mailer, EntityManagerInterface $entityManager)
    {
        ...
        </h4></center></br></center><center><h3>voici les coordonnéesde votre compte:</h3></center><br>
        <center>Email:'.$email.'</center><br>   </br>', 'text/html') ;
        ...
        $html = $this->renderView('reservation_voyage/index1.html.twig', [
            'reservation_voyages' => $reservationVoyages,$result
        ]);

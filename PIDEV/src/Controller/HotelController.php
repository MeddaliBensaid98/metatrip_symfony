...
class HotelController extends AbstractController
{
     ...
     */
    public function edit(FlashyNotifier $flashy ,Request $request, Hotel $hotel, EntityManagerInterface $entityManager): Response
    {
        $form = $this->createForm(HotelType::class, $hotel);
        $form->handleRequest($request);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $entityManager->flush();
            $flashy->success(' hotel supprimé avec succés!', 'http://your-awesome-link.com');
     ...
     */
    public function delete(FlashyNotifier $flashy ,Request $request, Hotel $hotel, EntityManagerInterface $entityManager): Response
    {
